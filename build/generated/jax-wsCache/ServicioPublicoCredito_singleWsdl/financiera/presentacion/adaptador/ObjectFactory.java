 ...
 * generated in the financiera.presentacion.adaptador package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResultadoEstadoClienteError_QNAME = new QName("http://schemas.datacontract.org/2004/07/SGE.Service.Contracts.Data", "Error");
    ...
    private final static QName _ObtenerEstadoClienteCodigoFinanciera_QNAME = new QName("http://ISTP1.Service.Contracts.Service", "codigoFinanciera");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: financiera.presentacion.adaptador
     * 
     */
    ...
    public JAXBElement<String> createResultadoEstadoClienteError(String value) {
        return new JAXBElement<String>(_ResultadoEstadoClienteError_QNAME, String.class, ResultadoEstadoCliente.class, value);
    }
    ...
    public JAXBElement<String> createObtenerEstadoClienteCodigoFinanciera(String value) {
        return new JAXBElement<String>(_ObtenerEstadoClienteCodigoFinanciera_QNAME, String.class, ObtenerEstadoCliente.class, value);
    }
    ...
    public JAXBElement<String> createInformarCreditoFinalizadoCodigoFinanciera(String value) {
        return new JAXBElement<String>(_ObtenerEstadoClienteCodigoFinanciera_QNAME, String.class, InformarCreditoFinalizado.class, value);
    }
    ...
    public JAXBElement<String> createInformarCreditoOtorgadoCodigoFinanciera(String value) {
        return new JAXBElement<String>(_ObtenerEstadoClienteCodigoFinanciera_QNAME, String.class, InformarCreditoOtorgado.class, value);
    }
    ...
    public JAXBElement<String> createResultadoOperacionError(String value) {
        return new JAXBElement<String>(_ResultadoEstadoClienteError_QNAME, String.class, ResultadoOperacion.class, value);
    }
